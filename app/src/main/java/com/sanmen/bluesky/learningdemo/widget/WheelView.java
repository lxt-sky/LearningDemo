	...
	private void initResourceIfNecessary() { 
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (centerDrawableTop == null) {
                centerDrawableTop = getContext().getResources().getDrawable(R.drawable.wheel_val,null);
            }
            if (centerDrawableBottom == null) {
                centerDrawableBottom = getContext().getResources().getDrawable(R.drawable.wheel_val,null);
            }
        }
